...
<div id="contents" class="contents">
	<div class="container px-4 px-lg-5 mt-5">
		<div class="row">
			...
			<form action="addCfbean.do" id="cfbean" method="post">
				<table class="form">
					<tbody>
						<tr>
							<th><label for="cno">상품번호</label></th>
							<td><input type="text" name="cno" id="cno" size="10" class="single100" required></td>
						</tr>
						<tr>
							<th><label for="ccode">상품코드</label></th>
							<td><input type="text" name="ccode" id="ccode" size="10" class="single100" placeholder="상품코드 입력" required></td>
						</tr>
						<tr>
